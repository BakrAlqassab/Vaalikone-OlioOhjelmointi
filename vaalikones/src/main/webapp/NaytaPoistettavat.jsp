...
%>
 ...
 <input id="submitnappi" type="submit" value="Takaisin" name="btnTakaisin" />                 
 </form>
  <form action="LisaaEhdokkaat.jsp">
 <input id="submitnappi" type="submit" value="Lissa Uusi Ehdikkaat" name="btnLisaa" />                 
 </form>
