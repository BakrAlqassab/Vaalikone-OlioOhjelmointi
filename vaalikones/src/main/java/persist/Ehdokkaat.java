...
public class Ehdokkaat implements Serializable {
	...
	public Ehdokkaat(int id, String sukunimi2, String etunimi2, String puolue2, String kotipaikkakunta2
			, int ika2, String mieduskunta, String mitaasioita, String ammatti2) {
	this.ehdokasId = id;
	this.sukunimi = sukunimi2;
	this.etunimi=etunimi2;
	this.puolue = puolue2;
	this.kotipaikkakunta = kotipaikkakunta2;
	this.ika = ika2;
	this.miksiEduskuntaan = mieduskunta;
	this.mitaAsioitaHaluatEdistaa = mitaasioita;
